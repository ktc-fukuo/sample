SELECT
      a."reborn2_id" AS "reborn2_id"
    , a."prev2_info" AS "prev2_info"
    , a."prev2_id" AS "prev2_id"
...
WHERE
    1 = 1 
    AND a."reborn2_id" = CAST (:reborn_2_id AS INTEGER) 
    AND UPPER (TRIM(TRAILING ' ' FROM a."prev2_info")) LIKE UPPER (CONCAT ('%', :prev_2_info, '%')) 
    AND a."prev2_id" = CAST (:prev_2_id AS INTEGER) 
