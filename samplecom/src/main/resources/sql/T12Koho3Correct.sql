SELECT
      a."koho3_id" AS "koho3_id"
    , a."koho3_info" AS "koho3_info"
...
WHERE
    1 = 1 
    AND a."koho3_id" = CAST (:koho_3_id AS INTEGER) 
    AND UPPER (TRIM(TRAILING ' ' FROM a."koho3_info")) LIKE UPPER (CONCAT ('%', :koho_3_info, '%')) 
