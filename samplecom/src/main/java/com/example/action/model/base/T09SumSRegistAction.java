 ...
 * @author emarfkrow
 */
public class T09SumSRegistAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> form) {
        ...
        List<Map<String, Object>> data = (List<Map<String, Object>>) form.get("T09SumGrid");
        if (data != null) {
            for (Map<String, Object> row : data) {
                ...
                T09Sum e = FormValidator.toBean(T09Sum.class.getName(), row);
