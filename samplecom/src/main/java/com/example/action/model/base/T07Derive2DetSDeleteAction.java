 ...
 * @author emarfkrow
 */
public class T07Derive2DetSDeleteAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime at, final String by, final Map<String, Object> form) {
        ...
        List<Map<String, Object>> data = (List<Map<String, Object>>) form.get("T07Derive2DetGrid");
        if (data != null) {
            for (Map<String, Object> row : data) {
                ...
                T07Derive2Det e = FormValidator.toBean(T07Derive2Det.class.getName(), row);
