 ...
 * @author emarfkrow
 */
public class T07PrevDetSDeleteAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> form) {
        ...
        List<Map<String, Object>> data = (List<Map<String, Object>>) form.get("T07PrevDetGrid");
        if (data != null) {
            for (Map<String, Object> row : data) {
                ...
                T07PrevDet e = FormValidator.toBean(T07PrevDet.class.getName(), row);
                if (e.delete() != 1) {
                    throw new OptLockError("error.cant.delete", "前世明細");
                }
                ++count;
