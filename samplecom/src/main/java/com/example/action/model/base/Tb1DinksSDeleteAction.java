 ...
 * @author emarfkrow
 */
public class Tb1DinksSDeleteAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> form) {
        ...
        List<Map<String, Object>> data = (List<Map<String, Object>>) form.get("Tb1DinksGrid");
        if (data != null) {
            for (Map<String, Object> row : data) {
                ...
                Tb1Dinks e = FormValidator.toBean(Tb1Dinks.class.getName(), row);
