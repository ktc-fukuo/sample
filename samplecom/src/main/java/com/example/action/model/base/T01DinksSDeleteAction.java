 ...
 * @author emarfkrow
 */
public class T01DinksSDeleteAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> form) {
        ...
        List<Map<String, Object>> data = (List<Map<String, Object>>) form.get("T01DinksGrid");
        if (data != null) {
            for (Map<String, Object> row : data) {
                ...
                T01Dinks e = FormValidator.toBean(T01Dinks.class.getName(), row);
                if (e.delete() != 1) {
                    throw new OptLockError("error.cant.delete", "子なし");
                }
                ++count;
