 ...
 * @author emarfkrow
 */
public class M04CdSRegistAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> form) {
        ...
        List<Map<String, Object>> data = (List<Map<String, Object>>) form.get("M04CdGrid");
        if (data != null) {
            for (Map<String, Object> row : data) {
                ...
                M04Cd e = FormValidator.toBean(M04Cd.class.getName(), row);
