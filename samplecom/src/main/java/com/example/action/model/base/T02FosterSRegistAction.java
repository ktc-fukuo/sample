 ...
 * @author emarfkrow
 */
public class T02FosterSRegistAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> form) {
        ...
        List<Map<String, Object>> data = (List<Map<String, Object>>) form.get("T02FosterGrid");
        if (data != null) {
            for (Map<String, Object> row : data) {
                ...
                T02Foster e = FormValidator.toBean(T02Foster.class.getName(), row);
