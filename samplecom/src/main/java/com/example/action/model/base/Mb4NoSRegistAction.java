 ...
 * @author emarfkrow
 */
public class Mb4NoSRegistAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> form) {
        ...
        List<Map<String, Object>> data = (List<Map<String, Object>>) form.get("Mb4NoGrid");
        if (data != null) {
            for (Map<String, Object> row : data) {
                ...
                Mb4No e = FormValidator.toBean(Mb4No.class.getName(), row);
