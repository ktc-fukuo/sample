 ...
 * @author emarfkrow
 */
public class Tb4SaikiSRegistAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> form) {
        ...
        List<Map<String, Object>> data = (List<Map<String, Object>>) form.get("Tb4SaikiGrid");
        if (data != null) {
            for (Map<String, Object> row : data) {
                ...
                // 主キーが不足していたらINSERT
                boolean isNew = false;
                if (jp.co.golorp.emarf.lang.StringUtil.isNullOrWhiteSpace(e.getSaikiId())) {
                    isNew = true;
                }
                // 楽観ロック値がなくてもINSERT
