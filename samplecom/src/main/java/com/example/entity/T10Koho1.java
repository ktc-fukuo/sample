...
public class T10Koho1 implements IEntity {
     ...
     * @return 候補１
     */
    public static T10Koho1 get(final Object param1) {
        ...
        return Queries.get(sql, map, T10Koho1.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 候補１の登録
        String sql = "INSERT INTO T10_KOHO1(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`KOHO1_ID`) IS NULL THEN 0 ELSE MAX(e.`KOHO1_ID`) * 1 END + 1 AS `KOHO1_ID` FROM T10_KOHO1 e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 候補１の削除
        String sql = "DELETE FROM T10_KOHO1 WHERE " + getWhere();
