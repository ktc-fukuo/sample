 ...
 * @author emarfkrow
 */
public class T10Koho2 implements IEntity {
     ...
     * @return 候補２
     */
    public static T10Koho2 get(final Object param1) {
        ...
        return Queries.get(sql, map, T10Koho2.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 候補２の登録
        String sql = "INSERT INTO T10_KOHO2(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`KOHO2_ID`) IS NULL THEN 0 ELSE MAX(e.`KOHO2_ID`) * 1 END + 1 AS `KOHO2_ID` FROM T10_KOHO2 e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 候補２の削除
        String sql = "DELETE FROM T10_KOHO2 WHERE " + getWhere();
