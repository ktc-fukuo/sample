 ...
 * @author emarfkrow
 */
public class Tb5Comp2 implements IEntity {
     ...
     * @return 複合２
     */
    public static Tb5Comp2 get(final Object param1, final Object param2, final Object param3, final Object param4) {
        ...
        return Queries.get(sql, map, Tb5Comp2.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 複合２の登録
        String sql = "INSERT INTO TB5_COMP2(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    public int delete() {
        ...
        // 複合２の削除
        String sql = "DELETE FROM TB5_COMP2 WHERE " + getWhere();
