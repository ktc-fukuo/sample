 ...
 * @author emarfkrow
 */
public class T09Koho2 implements IEntity {
    ...
    /** @param values */
    public T09Koho2(final String[] values) {
        this.setKoho2Id(values[0]);
        this.setKoho2Info(values[1]);
    ...
    /** @param map */
    public T09Koho2(final java.util.Map<String, Object> map) {
    ...
    public boolean isNew() {
        if (StringUtil.isNullOrWhiteSpace(this.koho2Id)) {
            return true;
        }
    ...
    /** @return KOHO2_ID */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "KOHO2_ID", index = 2)
    @jp.co.golorp.emarf.validation.PrimaryKeys
    ...
    /** @return KOHO2_INFO */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "KOHO2_INFO", index = 3)
     ...
     * @return 候補２
     */
    public static T09Koho2 get(final Object param1) {
        java.util.List<String> whereList = new java.util.ArrayList<String>();
        whereList.add("\"KOHO2_ID\" = :koho_2_id");
        String sql = "";
        sql += "SELECT \n";
        sql += "      a.\"KOHO2_ID\" \n";
        sql += "    , a.\"KOHO2_INFO\" \n";
        ...
        map.put("koho_2_id", param1);
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T09Koho2.class);
    }
    ...
    private void numbering() {
        if (this.koho2Id != null) {
            return;
        }
        String sql = "SELECT CASE WHEN MAX(e.\"KOHO2_ID\") IS NULL THEN 0 ELSE MAX(e.\"KOHO2_ID\") * 1 END + 1 AS \"KOHO2_ID\" FROM T09_KOHO2 e";
        java.util.Map<String, Object> map = new java.util.HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = jp.co.golorp.emarf.sql.Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("KOHO2_ID");
        this.setKoho2Id(o);
    }
