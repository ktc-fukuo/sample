 ...
 * @author emarfkrow
 */
public class Tb3TransHis implements IEntity {
     ...
     * @return 変遷履歴
     */
    public static Tb3TransHis get(final Object param1, final Object param2) {
        ...
        return Queries.get(sql, map, Tb3TransHis.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 変遷履歴の登録
        String sql = "INSERT INTO TB3_TRANS_HIS(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`TRANS_BN`) IS NULL THEN 0 ELSE MAX(e.`TRANS_BN`) * 1 END + 1 AS `TRANS_BN` FROM TB3_TRANS_HIS e";
        Map<String, Object> map = new HashMap<String, Object>();
        List<String> whereList = new ArrayList<String>();
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        // 変遷履歴の登録
        String sql = "UPDATE TB3_TRANS_HIS\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
    ...
    public int delete() {
        ...
        // 変遷履歴の削除
        String sql = "DELETE FROM TB3_TRANS_HIS WHERE " + getWhere();
