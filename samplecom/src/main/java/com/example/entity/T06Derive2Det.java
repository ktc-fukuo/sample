 ...
 * @author emarfkrow
 */
public class T06Derive2Det implements IEntity {
     ...
     * @return 派生２明細
     */
    public static T06Derive2Det get(final Object param1, final Object param2) {
        ...
        sql += "FROM \n";
        sql += "    T06_DERIVE2_DET a \n";
        sql += "WHERE \n";
        sql += String.join(" AND \n", whereList);
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("derive_2_id", param1);
        map.put("derive_2_bn", param2);
        return Queries.get(sql, map, T06Derive2Det.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 派生２明細の登録
        String sql = "INSERT INTO T06_DERIVE2_DET(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`DERIVE2_BN`) IS NULL THEN 0 ELSE MAX(e.`DERIVE2_BN`) * 1 END + 1 AS `DERIVE2_BN` FROM T06_DERIVE2_DET e";
        Map<String, Object> map = new HashMap<String, Object>();
        List<String> whereList = new ArrayList<String>();
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        // 派生２明細の登録
        String sql = "UPDATE T06_DERIVE2_DET\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
    ...
    public int delete() {
        ...
        // 派生２明細の削除
        String sql = "DELETE FROM T06_DERIVE2_DET WHERE " + getWhere();
