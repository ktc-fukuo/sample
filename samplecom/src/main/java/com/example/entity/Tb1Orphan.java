 ...
 * @author emarfkrow
 */
public class Tb1Orphan implements IEntity {
     ...
     * @return 孤児
     */
    public static Tb1Orphan get(final Object param1, final Object param2) {
        ...
        return Queries.get(sql, map, Tb1Orphan.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 子なしの登録
        if (this.tb1Dinks != null) {
            this.tb1Dinks.setOyaId(this.getOyaId());
            this.tb1Dinks.setKoBn(this.getKoBn());
            this.tb1Dinks.insert(now, execId);
        }
        ...
        // 孤児の登録
        String sql = "INSERT INTO TB1_ORPHAN(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`KO_BN`) IS NULL THEN 0 ELSE MAX(e.`KO_BN`) * 1 END + 1 AS `KO_BN` FROM TB1_ORPHAN e";
        Map<String, Object> map = new HashMap<String, Object>();
        List<String> whereList = new ArrayList<String>();
    ...
    public int delete() {
        ...
        // 孤児の削除
        String sql = "DELETE FROM TB1_ORPHAN WHERE " + getWhere();
    ...
    /** 兄弟：子なし */
    private Tb1Dinks tb1Dinks;

    /** @return 子なし */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "Tb1Dinks", index = 11)
    public Tb1Dinks getTb1Dinks() {
        return this.tb1Dinks;
    }

    /** @param p 子なし */
    public void setTb1Dinks(final Tb1Dinks p) {
        this.tb1Dinks = p;
    }

    /** @return 子なし */
    public Tb1Dinks referTb1Dinks() {
        if (this.tb1Dinks == null) {
            try {
                this.tb1Dinks = Tb1Dinks.get(this.oyaId, this.koBn);
    ...
    /** @return 子 */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "Tb1Ko", index = 12)
    ...
    public List<Tb4Mago> referTb4Magos() {
        this.tb4Magos = Tb1Orphan.referTb4Magos(this.oyaId, this.koBn);
        return this.tb4Magos;
    }
