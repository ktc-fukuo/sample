 ...
 * @author emarfkrow
 */
public class Tb6Kisei implements IEntity {
    ...
    private Integer kiseiId;

    /** @return 寄生ID */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "KISEI_ID", index = 2)
    @jp.co.golorp.emarf.validation.PrimaryKeys
    public Integer getKiseiId() {
        return this.kiseiId;
    }

    /** @param o 寄生ID */
    @jp.co.golorp.emarf.validation.PrimaryKeys
    public void setKiseiId(final Object o) {
        if (!jp.co.golorp.emarf.lang.StringUtil.isNullOrWhiteSpace(o)) {
            this.kiseiId = Integer.valueOf(o.toString());
        } else {
            this.kiseiId = null;
        }
    }
     ...
     * @return 寄生
     */
    public static Tb6Kisei get(final Object param1) {
        List<String> whereList = new ArrayList<String>();
        whereList.add("`KISEI_ID` = :kisei_id");
        String sql = "";
        sql += "SELECT \n";
        sql += "      a.`KISEI_ID` \n";
        sql += "    , a.`PREV_INFO` \n";
        ...
        map.put("kisei_id", param1);
        return Queries.get(sql, map, Tb6Kisei.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 寄生の登録
        String sql = "INSERT INTO TB6_KISEI(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String names() {
        ...
        nameList.add("`KISEI_ID` -- :kisei_id");
    ...
    private void numbering() {
        if (this.kiseiId != null) {
            return;
        }
        String sql = "SELECT CASE WHEN MAX(e.`KISEI_ID`) IS NULL THEN 0 ELSE MAX(e.`KISEI_ID`) * 1 END + 1 AS `KISEI_ID` FROM TB6_KISEI e";
        Map<String, Object> map = new HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("KISEI_ID");
        this.setKiseiId(o);
    }
    ...
    public int delete() {
        ...
        // 寄生の削除
        String sql = "DELETE FROM TB6_KISEI WHERE " + getWhere();
