 ...
 * @author emarfkrow
 */
public class T02Younger implements IEntity {
     ...
     * @return 弟
     */
    public static T02Younger get(final Object param1) {
        ...
        return Queries.get(sql, map, T02Younger.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 弟の登録
        String sql = "INSERT INTO T02_YOUNGER(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`BRO_ID`) IS NULL THEN 0 ELSE MAX(e.`BRO_ID`) * 1 END + 1 AS `BRO_ID` FROM T02_YOUNGER e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 弟の削除
        String sql = "DELETE FROM T02_YOUNGER WHERE " + getWhere();
    ...
    /** @return 末弟 */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "T02Youngest", index = 10)
