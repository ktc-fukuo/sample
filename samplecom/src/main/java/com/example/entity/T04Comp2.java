 ...
 * @author emarfkrow
 */
public class T04Comp2 implements IEntity {
    ...
    /** @param values */
    public T04Comp2(final String[] values) {
        this.setRef1Id(values[0]);
        this.setRef2Id(values[1]);
        this.setRef3Id(values[2]);
        this.setTekiyoBi(values[3]);
        this.setComp2Info(values[4]);
    ...
    /** @param map */
    public T04Comp2(final java.util.Map<String, Object> map) {
        ...
        this.setComp2Info(IgnoreCaseLinkedMap.get(map, "COMP2_INFO"));
    ...
    public boolean isNew() {
        if (StringUtil.isNullOrWhiteSpace(this.ref1Id)) {
            ...
            return true;
        } else if (StringUtil.isNullOrWhiteSpace(this.ref3Id)) {
            return true;
    ...
    public boolean isEmpty() {
        ...
        isEmpty &= this.comp2Info == null || this.comp2Info.toString().replaceAll("　| ", "").equals("");
        return isEmpty;
    }
    ...
    public void setRef3Id(final Object o) {
        this.ref3Id = StringUtil.ifNullInteger(o);
    }
    ...
    public void setComp2Info(final Object o) {
        this.comp2Info = StringUtil.ifNull(o);
    }
    ...
    public static T04Comp2 get(final Object param1, final Object param2, final Object param3, final Object param4) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T04Comp2.class);
    }
