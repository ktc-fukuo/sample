...
public class M04No implements IEntity {
     ...
     * @return NOマスタ
     */
    public static M04No get(final Object param1) {
        ...
        return Queries.get(sql, map, M04No.class);
    }
    ...
    public int delete() {
        ...
        // NOマスタの削除
        String sql = "DELETE FROM M04_NO WHERE " + getWhere();
