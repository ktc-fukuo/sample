 ...
 * @author emarfkrow
 */
public class Mb5Ref3 implements IEntity {
     ...
     * @return マスタ参照３
     */
    public static Mb5Ref3 get(final Object param1) {
        ...
        return Queries.get(sql, map, Mb5Ref3.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // マスタ参照３の登録
        String sql = "INSERT INTO MB5_REF3(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`REF3_ID`) IS NULL THEN 0 ELSE MAX(e.`REF3_ID`) * 1 END + 1 AS `REF3_ID` FROM MB5_REF3 e";
        Map<String, Object> map = new HashMap<String, Object>();
