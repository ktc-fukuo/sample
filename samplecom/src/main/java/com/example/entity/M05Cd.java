 ...
 * @author emarfkrow
 */
public class M05Cd implements IEntity {
    ...
    /** @param values */
    public M05Cd(final String[] values) {
        this.setCdrefCd(values[0]);
        this.setCdrefMei(values[1]);
    ...
    /** @param map */
    public M05Cd(final java.util.Map<String, Object> map) {
        this.setCdrefCd(IgnoreCaseLinkedMap.get(map, "CDREF_CD"));
        this.setCdrefMei(IgnoreCaseLinkedMap.get(map, "CDREF_MEI"));
    ...
    public boolean isNew() {
        if (StringUtil.isNullOrWhiteSpace(this.cdrefCd)) {
            return true;
        }
    ...
    public boolean isEmpty() {
        ...
        isEmpty &= this.cdrefMei == null || this.cdrefMei.toString().replaceAll("　| ", "").equals("");
        return isEmpty;
    }
    ...
    public void setCdrefMei(final Object o) {
        this.cdrefMei = StringUtil.ifNull(o);
    }
    ...
    public static M05Cd get(final Object param1) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, M05Cd.class);
    }
    ...
    /** @return 削除件数 */
    public int delete() {
        String sql = "DELETE FROM M05_CD WHERE " + getWhere();
        return jp.co.golorp.emarf.sql.Queries.regist(sql, toMap(null, null));
    }

    /** @return 削除件数 */
    public static int truncate() {
        String sql = "TRUNCATE TABLE M05_CD";
