 ...
 * @author emarfkrow
 */
public class T13Src implements IEntity {
    ...
    /** @param values */
    public T13Src(final String[] values) {
        this.setSrcId(values[0]);
        this.setSrcInfo(values[1]);
    ...
    /** @param map */
    public T13Src(final java.util.Map<String, Object> map) {
        this.setSrcId(IgnoreCaseLinkedMap.get(map, "SRC_ID"));
        this.setSrcInfo(IgnoreCaseLinkedMap.get(map, "SRC_INFO"));
    ...
    public boolean isNew() {
        if (StringUtil.isNullOrWhiteSpace(this.srcId)) {
            return true;
        }
    ...
    public boolean isEmpty() {
        ...
        isEmpty &= this.srcInfo == null || this.srcInfo.toString().replaceAll("　| ", "").equals("");
        return isEmpty;
    }
    ...
    /** @return SRC_ID */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "SRC_ID", index = 2)
    @jp.co.golorp.emarf.validation.PrimaryKeys
    ...
    /** @return SRC_INFO */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "SRC_INFO", index = 3)
    public String getSrcInfo() {
        return this.srcInfo;
    }

    /** @param o SRC_INFO */
    public void setSrcInfo(final Object o) {
        this.srcInfo = StringUtil.ifNull(o);
    }
    ...
    public static T13Src get(final Object param1) {
        ...
        map.put("src_id", param1);
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T13Src.class);
    }
    ...
    public int insert(final java.time.LocalDateTime at, final String by) {
        ...
        String sql = "INSERT INTO T13_SRC(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    /** @return 削除件数 */
    public int delete() {
        String sql = "DELETE FROM T13_SRC WHERE " + getWhere();
        return jp.co.golorp.emarf.sql.Queries.regist(sql, toMap(null, null));
    }

    /** @return 削除件数 */
    public static int truncate() {
        String sql = "TRUNCATE TABLE T13_SRC";
