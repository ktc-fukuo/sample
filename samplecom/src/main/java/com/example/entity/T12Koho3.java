 ...
 * @author emarfkrow
 */
public class T12Koho3 implements IEntity {
    ...
    /** @param values */
    public T12Koho3(final String[] values) {
        this.setKoho3Id(values[0]);
        this.setKoho3Info(values[1]);
    ...
    /** @param map */
    public T12Koho3(final java.util.Map<String, Object> map) {
        this.setKoho3Id(IgnoreCaseLinkedMap.get(map, "KOHO3_ID"));
        this.setKoho3Info(IgnoreCaseLinkedMap.get(map, "KOHO3_INFO"));
    ...
    public boolean isNew() {
        if (StringUtil.isNullOrWhiteSpace(this.koho3Id)) {
            return true;
        }
    ...
    public boolean isEmpty() {
        ...
        isEmpty &= this.koho3Info == null || this.koho3Info.toString().replaceAll("　| ", "").equals("");
        return isEmpty;
    }
    ...
    /** @return KOHO3_ID */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "KOHO3_ID", index = 2)
    @jp.co.golorp.emarf.validation.PrimaryKeys
    ...
    /** @return KOHO3_INFO */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "KOHO3_INFO", index = 3)
    public String getKoho3Info() {
        return this.koho3Info;
    }

    /** @param o KOHO3_INFO */
    public void setKoho3Info(final Object o) {
        this.koho3Info = StringUtil.ifNull(o);
    }
    ...
    public static T12Koho3 get(final Object param1) {
        ...
        map.put("koho_3_id", param1);
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T12Koho3.class);
    }
    ...
    public int insert(final java.time.LocalDateTime at, final String by) {
        ...
        String sql = "INSERT INTO T12_KOHO3(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    /** @return 削除件数 */
    public int delete() {
        String sql = "DELETE FROM T12_KOHO3 WHERE " + getWhere();
    ...
    private java.util.Map<String, Object> toMap(final java.time.LocalDateTime at, final String by) {
        ...
        map.put("koho_3_info", this.koho3Info);
