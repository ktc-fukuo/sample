 ...
 * @author emarfkrow
 */
public class T02Ko implements IEntity {
    ...
    /** @param values */
    public T02Ko(final String[] values) {
        this.setOyaId(values[0]);
        this.setKoBn(values[1]);
        this.setKoInfo(values[2]);
    ...
    /** @param map */
    public T02Ko(final java.util.Map<String, Object> map) {
        this.setOyaId(IgnoreCaseLinkedMap.get(map, "OYA_ID"));
        this.setKoBn(IgnoreCaseLinkedMap.get(map, "KO_BN"));
        this.setKoInfo(IgnoreCaseLinkedMap.get(map, "KO_INFO"));
    ...
    public void setKoInfo(final Object o) {
        this.koInfo = StringUtil.ifNull(o);
    }
     ...
     * @return 子
     */
    public static T02Ko get(final Object param1, final Object param2) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T02Ko.class);
    }
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.\"KO_BN\") IS NULL THEN 0 ELSE MAX(e.\"KO_BN\") * 1 END + 1 AS \"KO_BN\" FROM T02_KO e";
        java.util.Map<String, Object> map = new java.util.HashMap<String, Object>();
        java.util.List<String> whereList = new java.util.ArrayList<String>();
    ...
    public static int truncate() {
        ...
        if (jp.co.golorp.emarf.sql.Queries.select("SELECT COUNT (1) FROM T02_MAGO", null, null).size() > 0) {
            throw new jp.co.golorp.emarf.exception.OptLockError("error.cant.truncate", "T02_KO by T02_MAGO");
        }

        String sql = "TRUNCATE TABLE T02_KO";
