 ...
 * @author emarfkrow
 */
public class Tb6Kisei2 implements IEntity {
     ...
     * @return 寄生
     */
    public static Tb6Kisei2 get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb6Kisei2.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 寄生の登録
        String sql = "INSERT INTO TB6_KISEI2(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`KISEI2_ID`) IS NULL THEN 0 ELSE MAX(e.`KISEI2_ID`) * 1 END + 1 AS `KISEI2_ID` FROM TB6_KISEI2 e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 寄生の削除
        String sql = "DELETE FROM TB6_KISEI2 WHERE " + getWhere();
