 ...
 * @author emarfkrow
 */
public class M04Ref2 implements IEntity {
    ...
    /** @param values */
    public M04Ref2(final String[] values) {
        this.setRef2Id(values[0]);
        this.setRef2Mei(values[1]);
    ...
    /** @param map */
    public M04Ref2(final java.util.Map<String, Object> map) {
        this.setRef2Id(IgnoreCaseLinkedMap.get(map, "REF2_ID"));
        this.setRef2Mei(IgnoreCaseLinkedMap.get(map, "REF2_MEI"));
    ...
    public boolean isNew() {
        if (StringUtil.isNullOrWhiteSpace(this.ref2Id)) {
            return true;
        }
    ...
    public boolean isEmpty() {
        ...
        isEmpty &= this.ref2Mei == null || this.ref2Mei.toString().replaceAll("　| ", "").equals("");
    ...
    /** @return REF2_ID */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "REF2_ID", index = 2)
    @jp.co.golorp.emarf.validation.PrimaryKeys
    ...
    /** @return REF2_MEI */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "REF2_MEI", index = 3)
    ...
    public void setRef2Mei(final Object o) {
        this.ref2Mei = StringUtil.ifNull(o);
    }
     ...
     * @return マスタ参照２
     */
    public static M04Ref2 get(final Object param1) {
        ...
        map.put("ref_2_id", param1);
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, M04Ref2.class);
    }
    ...
    public int insert(final java.time.LocalDateTime at, final String by) {
        ...
        String sql = "INSERT INTO M04_REF2(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String names() {
        ...
        nameList.add("\"REF2_MEI\" -- :ref_2_mei");
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.\"REF2_ID\") IS NULL THEN 0 ELSE MAX(e.\"REF2_ID\") * 1 END + 1 AS \"REF2_ID\" FROM M04_REF2 e";
        java.util.Map<String, Object> map = new java.util.HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = jp.co.golorp.emarf.sql.Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("REF2_ID");
        this.setRef2Id(o);
    }
    ...
    private String getSet() {
        ...
        setList.add("\"REF2_MEI\" = :ref_2_mei");
    ...
    public static int truncate() {
        String sql = "TRUNCATE TABLE M04_REF2";
    ...
    private java.util.Map<String, Object> toMap(final java.time.LocalDateTime at, final String by) {
        ...
        map.put("ref_2_mei", this.ref2Mei);
