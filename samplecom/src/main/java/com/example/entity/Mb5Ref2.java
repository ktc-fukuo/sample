 ...
 * @author emarfkrow
 */
public class Mb5Ref2 implements IEntity {
     ...
     * @return マスタ参照２
     */
    public static Mb5Ref2 get(final Object param1) {
        ...
        return Queries.get(sql, map, Mb5Ref2.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // マスタ参照２の登録
        String sql = "INSERT INTO MB5_REF2(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`REF2_ID`) IS NULL THEN 0 ELSE MAX(e.`REF2_ID`) * 1 END + 1 AS `REF2_ID` FROM MB5_REF2 e";
        Map<String, Object> map = new HashMap<String, Object>();
