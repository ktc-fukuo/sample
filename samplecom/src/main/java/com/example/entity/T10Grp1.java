 ...
 * @author emarfkrow
 */
public class T10Grp1 implements IEntity {
    ...
    /** @param values */
    public T10Grp1(final String[] values) {
        this.setGrp1Id(values[0]);
    ...
    /** @param map */
    public T10Grp1(final java.util.Map<String, Object> map) {
        this.setGrp1Id(IgnoreCaseLinkedMap.get(map, "GRP1_ID"));
    ...
    public boolean isNew() {
        if (StringUtil.isNullOrWhiteSpace(this.grp1Id)) {
            return true;
        }
    ...
    public void setGrp1Id(final Object o) {
        this.grp1Id = StringUtil.ifNullInteger(o);
    }
     ...
     * @return 集団１
     */
    public static T10Grp1 get(final Object param1) {
        java.util.List<String> whereList = new java.util.ArrayList<String>();
        whereList.add("\"grp1_id\" = CAST (:grp_1_id AS INTEGER)");
        String sql = "";
        sql += "SELECT \n";
        sql += "      a.\"grp1_id\" \n";
        sql += "    , a.\"sum_id\" \n";
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T10Grp1.class);
    }
    ...
    public int insert(final java.time.LocalDateTime at, final String by) {
        ...
        String sql = "INSERT INTO T10_GRP1(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String values() {
        ...
        valueList.add("CAST (:grp_1_id AS INTEGER)");
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.\"grp1_id\") IS NULL THEN 0 ELSE MAX(e.\"grp1_id\") * 1 END + 1 AS \"grp1_id\" FROM T10_GRP1 e";
        java.util.Map<String, Object> map = new java.util.HashMap<String, Object>();
    ...
    private String getSet() {
        ...
        setList.add("\"grp1_id\" = CAST (:grp_1_id AS INTEGER)");
    ...
    /** @return 削除件数 */
    public int delete() {
        String sql = "DELETE FROM T10_GRP1 WHERE " + getWhere();
        return jp.co.golorp.emarf.sql.Queries.regist(sql, toMap(null, null));
    }

    /** @return 削除件数 */
    public static int truncate() {
        String sql = "TRUNCATE TABLE T10_GRP1";
