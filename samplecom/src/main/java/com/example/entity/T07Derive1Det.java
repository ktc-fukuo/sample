...
public class T07Derive1Det implements IEntity {
    ...
    public boolean isNew() {
        if (StringUtil.isNullOrWhiteSpace(this.derive1Id)) {
            return true;
        } else if (StringUtil.isNullOrWhiteSpace(this.derive1Bn)) {
            return true;
        }
    ...
    public void setDerive1Bn(final Object o) {
        this.derive1Bn = StringUtil.ifNullInteger(o);
    }
    ...
    public static T07Derive1Det get(final Object param1, final Object param2) {
        ...
        whereList.add("\"derive1_bn\" = CAST (:derive_1_bn AS INTEGER)");
        String sql = "";
        sql += "SELECT \n";
        sql += "      a.\"derive1_id\" \n";
        sql += "    , a.\"derive1_bn\" \n";
    ...
    private String values() {
        ...
        valueList.add("CAST (:derive_1_bn AS INTEGER)");
    ...
    private String getSet() {
        ...
        setList.add("\"derive1_bn\" = CAST (:derive_1_bn AS INTEGER)");
