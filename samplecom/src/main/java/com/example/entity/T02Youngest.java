 ...
 * @author emarfkrow
 */
public class T02Youngest implements IEntity {
     ...
     * @return 末弟
     */
    public static T02Youngest get(final Object param1) {
        ...
        return Queries.get(sql, map, T02Youngest.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 末弟の登録
        String sql = "INSERT INTO T02_YOUNGEST(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`BRO_ID`) IS NULL THEN 0 ELSE MAX(e.`BRO_ID`) * 1 END + 1 AS `BRO_ID` FROM T02_YOUNGEST e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        // 末弟の登録
        String sql = "UPDATE T02_YOUNGEST\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
    ...
    public int delete() {
        ...
        // 末弟の削除
        String sql = "DELETE FROM T02_YOUNGEST WHERE " + getWhere();
