...
public class T11Tasho1 implements IEntity {
    ...
    public boolean isNew() {
        if (StringUtil.isNullOrWhiteSpace(this.tasho1Id)) {
            return true;
        }
    ...
    public boolean isEmpty() {
        ...
        isEmpty &= this.reborn2Id == null || this.reborn2Id.toString().replaceAll("　| ", "").equals("");
        return isEmpty;
    }
    ...
    public void setTasho1Id(final Object o) {
        this.tasho1Id = StringUtil.ifNullInteger(o);
    }
    ...
    public static int truncate() {
        String sql = "TRUNCATE TABLE T11_TASHO1";
