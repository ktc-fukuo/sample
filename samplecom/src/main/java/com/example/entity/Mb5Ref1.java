 ...
 * @author emarfkrow
 */
public class Mb5Ref1 implements IEntity {
     ...
     * @return マスタ参照１
     */
    public static Mb5Ref1 get(final Object param1) {
        ...
        return Queries.get(sql, map, Mb5Ref1.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // マスタ参照１の登録
        String sql = "INSERT INTO MB5_REF1(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`REF1_ID`) IS NULL THEN 0 ELSE MAX(e.`REF1_ID`) * 1 END + 1 AS `REF1_ID` FROM MB5_REF1 e";
        Map<String, Object> map = new HashMap<String, Object>();
