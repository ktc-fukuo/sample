 ...
 * @author emarfkrow
 */
public class T08Kisei2 implements IEntity {
    ...
    /** @param values */
    public T08Kisei2(final String[] values) {
        this.setKisei2Id(values[0]);
        this.setKisei2Info(values[1]);
    ...
    /** @param map */
    public T08Kisei2(final java.util.Map<String, Object> map) {
    ...
    public boolean isNew() {
        if (StringUtil.isNullOrWhiteSpace(this.kisei2Id)) {
            return true;
        }
    ...
    /** @return KISEI2_ID */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "KISEI2_ID", index = 2)
    @jp.co.golorp.emarf.validation.PrimaryKeys
    ...
    /** @return KISEI2_INFO */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "KISEI2_INFO", index = 3)
     ...
     * @return 寄生２
     */
    public static T08Kisei2 get(final Object param1) {
        java.util.List<String> whereList = new java.util.ArrayList<String>();
        whereList.add("\"kisei2_id\" = CAST (:kisei_2_id AS INTEGER)");
        String sql = "";
        sql += "SELECT \n";
        sql += "      a.\"kisei2_id\" \n";
        sql += "    , a.\"kisei2_info\" \n";
        ...
        map.put("kisei_2_id", param1);
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T08Kisei2.class);
    }
    ...
    public int insert(final java.time.LocalDateTime at, final String by) {
        ...
        String sql = "INSERT INTO T08_KISEI2(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        if (this.kisei2Id != null) {
            return;
        }
        String sql = "SELECT CASE WHEN MAX(e.\"kisei2_id\") IS NULL THEN 0 ELSE MAX(e.\"kisei2_id\") * 1 END + 1 AS \"kisei2_id\" FROM T08_KISEI2 e";
        java.util.Map<String, Object> map = new java.util.HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = jp.co.golorp.emarf.sql.Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("KISEI2_ID");
        this.setKisei2Id(o);
    }
    ...
    /** @return 削除件数 */
    public int delete() {
        String sql = "DELETE FROM T08_KISEI2 WHERE " + getWhere();
        return jp.co.golorp.emarf.sql.Queries.regist(sql, toMap(null, null));
    }

    /** @return 削除件数 */
    public static int truncate() {
        String sql = "TRUNCATE TABLE T08_KISEI2";
