 ...
 * @author emarfkrow
 */
public class T01Younger implements IEntity {
    ...
    /** @param values */
    public T01Younger(final String[] values) {
        this.setBroId(values[0]);
        this.setYoungerInfo(values[1]);
    ...
    /** @param map */
    public T01Younger(final java.util.Map<String, Object> map) {
        this.setBroId(IgnoreCaseLinkedMap.get(map, "BRO_ID"));
        this.setYoungerInfo(IgnoreCaseLinkedMap.get(map, "YOUNGER_INFO"));
    ...
    public boolean isNew() {
        if (StringUtil.isNullOrWhiteSpace(this.broId)) {
            return true;
        }
    ...
    public boolean isEmpty() {
        ...
        isEmpty &= this.youngerInfo == null || this.youngerInfo.toString().replaceAll("　| ", "").equals("");
        return isEmpty;
    }
    ...
    public void setBroId(final Object o) {
        this.broId = StringUtil.ifNullInteger(o);
    }
    ...
    /** @param o YOUNGER_INFO */
    public void setYoungerInfo(final Object o) {
        this.youngerInfo = StringUtil.ifNull(o);
    }
     ...
     * @return 弟
     */
    public static T01Younger get(final Object param1) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T01Younger.class);
    }
    ...
    public int insert(final java.time.LocalDateTime at, final String by) {
        ...
        String sql = "INSERT INTO T01_YOUNGER(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.\"BRO_ID\") IS NULL THEN 0 ELSE MAX(e.\"BRO_ID\") * 1 END + 1 AS \"BRO_ID\" FROM T01_YOUNGER e";
        java.util.Map<String, Object> map = new java.util.HashMap<String, Object>();
    ...
    /** @return 削除件数 */
    public int delete() {
        String sql = "DELETE FROM T01_YOUNGER WHERE " + getWhere();
        return jp.co.golorp.emarf.sql.Queries.regist(sql, toMap(null, null));
    }

    /** @return 削除件数 */
    public static int truncate() {
        String sql = "TRUNCATE TABLE T01_YOUNGER";
