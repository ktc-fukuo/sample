...
public class MsyKadobi implements IEntity {
    ...
    public boolean isNew() {
        if (StringUtil.isNullOrWhiteSpace(this.kadoYmd)) {
            return true;
        } else if (StringUtil.isNullOrWhiteSpace(this.bushoId)) {
            return true;
        }
    ...
    public void setKadoYmd(final Object o) {
        this.kadoYmd = StringUtil.ifNull(o);
    }
    ...
    public void setKadobiF(final Object o) {
        this.kadobiF = StringUtil.ifNull(o);
    }
