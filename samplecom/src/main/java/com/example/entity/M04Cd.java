 ...
 * @author emarfkrow
 */
public class M04Cd implements IEntity {
     ...
     * @return CDマスタ
     */
    public static M04Cd get(final Object param1) {
        ...
        return Queries.get(sql, map, M04Cd.class);
    }
    ...
    public int delete() {
        ...
        // CDマスタの削除
        String sql = "DELETE FROM M04_CD WHERE " + getWhere();
