 ...
 * @author emarfkrow
 */
public class M05Ref2 implements IEntity {
     ...
     * @return マスタ参照２
     */
    public static M05Ref2 get(final Object param1) {
        ...
        return Queries.get(sql, map, M05Ref2.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // マスタ参照２の登録
        String sql = "INSERT INTO M05_REF2(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`REF2_ID`) IS NULL THEN 0 ELSE MAX(e.`REF2_ID`) * 1 END + 1 AS `REF2_ID` FROM M05_REF2 e";
        Map<String, Object> map = new HashMap<String, Object>();
