 ...
 * @author emarfkrow
 */
public class T02Foster implements IEntity {
     ...
     * @return 里子
     */
    public static T02Foster get(final Object param1) {
        ...
        return Queries.get(sql, map, T02Foster.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 里子の登録
        String sql = "INSERT INTO T02_FOSTER(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`BRO_ID`) IS NULL THEN 0 ELSE MAX(e.`BRO_ID`) * 1 END + 1 AS `BRO_ID` FROM T02_FOSTER e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 里子の削除
        String sql = "DELETE FROM T02_FOSTER WHERE " + getWhere();
