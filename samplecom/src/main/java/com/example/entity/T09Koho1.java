 ...
 * @author emarfkrow
 */
public class T09Koho1 implements IEntity {
    ...
    /** @param values */
    public T09Koho1(final String[] values) {
        this.setKoho1Id(values[0]);
        this.setKoho1Info(values[1]);
    ...
    /** @param map */
    public T09Koho1(final java.util.Map<String, Object> map) {
    ...
    public boolean isNew() {
        if (StringUtil.isNullOrWhiteSpace(this.koho1Id)) {
            return true;
        }
     ...
     * @return 候補１
     */
    public static T09Koho1 get(final Object param1) {
        java.util.List<String> whereList = new java.util.ArrayList<String>();
        whereList.add("\"KOHO1_ID\" = :koho_1_id");
        String sql = "";
        sql += "SELECT \n";
        sql += "      a.\"KOHO1_ID\" \n";
        sql += "    , a.\"KOHO1_INFO\" \n";
        ...
        map.put("koho_1_id", param1);
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T09Koho1.class);
    }
    ...
    public int insert(final java.time.LocalDateTime at, final String by) {
        ...
        String sql = "INSERT INTO T09_KOHO1(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        if (this.koho1Id != null) {
            return;
        }
        String sql = "SELECT CASE WHEN MAX(e.\"KOHO1_ID\") IS NULL THEN 0 ELSE MAX(e.\"KOHO1_ID\") * 1 END + 1 AS \"KOHO1_ID\" FROM T09_KOHO1 e";
        java.util.Map<String, Object> map = new java.util.HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = jp.co.golorp.emarf.sql.Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("KOHO1_ID");
        this.setKoho1Id(o);
    }
    ...
    /** @return 削除件数 */
    public int delete() {
        String sql = "DELETE FROM T09_KOHO1 WHERE " + getWhere();
        return jp.co.golorp.emarf.sql.Queries.regist(sql, toMap(null, null));
    }

    /** @return 削除件数 */
    public static int truncate() {
        String sql = "TRUNCATE TABLE T09_KOHO1";
