...
public class T04Comp1RegistForm implements IForm {
    ...
    private java.util.List<T04Comp2RegistForm> t04Comp2Grid;

    /**
     * @return 複合２
     */
    public java.util.List<T04Comp2RegistForm> getT04Comp2Grid() {
        return t04Comp2Grid;
    }
     ...
     * @param p
     */
    public void setT04Comp2Grid(final java.util.List<T04Comp2RegistForm> p) {
        this.t04Comp2Grid = p;
    }
