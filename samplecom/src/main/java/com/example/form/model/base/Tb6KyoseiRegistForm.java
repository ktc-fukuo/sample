 ...
 * @author emarfkrow
 */
public class Tb6KyoseiRegistForm implements IForm {
    ...
    public void validate(final Map<String, String> errors, final BaseProcess baseProcess) {
        ...
        baseProcess.masterCheck(errors, "Tb6PrevSearch", "prevId", prevIdParams, jp.co.golorp.emarf.util.Messages.get("Tb6Kyosei.prevId"));
        ...
        baseProcess.masterCheck(errors, "Tb6OrgSearch", "orgId", orgIdParams, jp.co.golorp.emarf.util.Messages.get("Tb6Kyosei.orgId"));
    }
}
